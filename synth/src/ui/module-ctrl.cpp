...
char* ModuleCtrl::windowClassName_ = "ModuleCtrl";
ATOM ModuleCtrl::windowClass_ = 0;

int ModuleCtrl::presetBankSetter(void* obj, PresetBank* pb, void* args) {
	return 0;
}

int ModuleCtrl::presetSetter(void* obj, int prId, void* args) {
	return 0;
}

//void ModuleCtrl::onSelectProgram(ComboboxCtrl* cbCtrl, int prgId, void* args) {
//}

ModuleCtrl::ModuleCtrl() : ModuleCtrl(NULL) {}

ModuleCtrl::ModuleCtrl(DeviceExt* deviceExt) : DeviceCtrl(deviceExt) {
}
...
char* const ModuleCtrl::registerWindowClass() {
	if (ModuleCtrl::windowClass_ == 0) {
		ModuleCtrl::windowClass_ = Window::registerClass(ModuleCtrl::windowClassName_, NULL, 0);
	}
	return ModuleCtrl::windowClassName_;
}

//void ModuleCtrl::create(Window* parent, char* name, LONG style, DWORD exStyle) {

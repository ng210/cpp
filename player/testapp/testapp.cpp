...
char* windowClassName = "PlayerTestApp";
...
LRESULT TestApp::onCreated() {
	...
	//#pragma region Init test controls
	//nextButton_.createWindow(this, "Next");
	//nextButton_.show(px, py, 48, 24);
	//nextButton_.onLeftClick(&TestApp::nextTest);
	//px += nextButton_.rect().right + margin;
	//restartButton_.createWindow(this, "Restart");
	//restartButton_.show(px, py, 64, 24);
	//px += restartButton_.rect().right + margin;
	//#pragma endregion

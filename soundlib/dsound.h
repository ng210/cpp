...
typedef HRESULT WINAPI DIRECTSOUNDCREATE(LPCGUID pcGuidDevice, LPDIRECTSOUND *ppDS, LPUNKNOWN pUnkOuter);
typedef DIRECTSOUNDCREATE *LPDIRECTSOUNDCREATE;
...
typedef HRESULT WINAPI DIRECTSOUNDCREATE8(LPCGUID pcGuidDevice, LPDIRECTSOUND8 *ppDS8, LPUNKNOWN pUnkOuter);
typedef HRESULT WINAPI DIRECTSOUNDCAPTURECREATE8(LPCGUID pcGuidDevice, LPDIRECTSOUNDCAPTURE8 *ppDSC8, LPUNKNOWN pUnkOuter);
typedef HRESULT WINAPI DIRECTSOUNDFULLDUPLEXCREATE(LPCGUID pcGuidCaptureDevice, LPCGUID pcGuidRenderDevice,
	LPCDSCBUFFERDESC pcDSCBufferDesc, LPCDSBUFFERDESC pcDSBufferDesc, HWND hWnd,
	DWORD dwLevel, LPDIRECTSOUNDFULLDUPLEX* ppDSFD, LPDIRECTSOUNDCAPTUREBUFFER8 *ppDSCBuffer8,
	LPDIRECTSOUNDBUFFER8 *ppDSBuffer8, LPUNKNOWN pUnkOuter);
typedef DIRECTSOUNDCREATE8 *LPDIRECTSOUNDCREATE8;
typedef DIRECTSOUNDCAPTURECREATE8 *LPDIRECTSOUNDCAPTURECREATE8;
typedef DIRECTSOUNDFULLDUPLEXCREATE *LPDIRECTSOUNDFULLDUPLEXCREATE;
